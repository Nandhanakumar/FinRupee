...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About FinGrove — Free Finance Calculators for India" },
      { name: "description", content: "FinGrove is a free toolkit of financial calculators, investing guides and money Q&A built for Indian investors. Learn what we do and why." },
      { property: "og:title", content: "About FinGrove" },
...
function Page() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6 sm:py-20">
      <h1 className="text-3xl font-extrabold tracking-tight text-foreground sm:text-4xl">About FinGrove</h1>
      <p className="mt-5 text-lg text-muted-foreground">
        FinGrove is a free toolkit for Indian investors — 14+ financial calculators, plain-English guides and
      ...
      <div className="mt-10 space-y-6 text-base leading-relaxed text-foreground/90">
        <p>
          We built FinGrove because most "money" sites are either trying to sell you a product or drown
        ...
        <p className="text-sm text-muted-foreground">
          FinGrove is informational. We are not SEBI-registered investment advisors. Please consult a
